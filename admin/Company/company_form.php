...
<tr><th colspan="2">Register Your Company</th></tr>
<tr>
	<td>Company Name :</td>
...
$query = "INSERT INTO company_details (C_name,C_location,C_address,C_email,C_mobile,C_phone,C_password) VALUES('$_POST[cname]','$_POST[location]','$_POST[address]','$_POST[email]','$_POST[mobile]','$_POST[phone]','$_POST[password]')";
