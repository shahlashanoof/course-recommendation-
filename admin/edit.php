...
if(isset($_POST['submit']))
{
    ...
    $query = "UPDATE job_details SET J_title = '$jobtitle', J_close = '$close', J_email = '$email', J_description = '$jobdesc', J_skills = '$skills', J_experience = '$exp', vacancy = '$vacancy', qualification = '$qualification', place_vacant = '$place_vacant', place_interview = '$place_interview', interview_time = '$interview_time' WHERE J_id = '$j_id'" ;
