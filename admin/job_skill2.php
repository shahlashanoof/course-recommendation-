...
$query = "INSERT INTO skills(ref_id,skill,rate,dtype) VALUES('$_REQUEST[bid]','$_POST[skill]','$_POST[rate]','canidate')";
mysql_query($query) or die('Error: ' . mysql_error($con));

}


$result = mysql_query("SELECT * FROM skills where ref_id='$_REQUEST[bid]' and dtype='canidate'");
?>
