...
$query = "INSERT INTO job_details(J_title,J_close,J_email,J_description,J_skills,J_experience,J_user,J_posted,J_type,vacancy,qualification,place_vacant,place_interview,interview_time,salary) VALUES('$_POST[jobtitle]','$_POST[close]','$_POST[email]','$_POST[job_desc]','$_POST[skills]','$_POST[experience]','$user','$date','$type','$_POST[vacancy]','$_POST[qualification]','$_POST[place_vacant]','$_POST[place_interview]','$_POST[interview_time]','$_POST[salary]')";
